...
def noise2(x, y):
    ...
    i1 = 1 if xx[0] > yy[0] else 0
    j1 = 1 if xx[0] <= yy[0] else 0

    # Set up the other two corners of the triangle
    ...
    I = int(i) & 255
    J = int(j) & 255
    g[0] = PERM[I + PERM[J]] % 16
    g[1] = PERM[I + i1 + PERM[J + j1]] % 16
    g[2] = PERM[I + 1 + PERM[J + 1]] % 16
