...
class DrumsPerlinGenerator(GeneratorBase, CommandLineArgumentAdder):
    ...
    async def run_procedure(self):
        ...
        # img.save(f"simplex-noise/drums/{self.n}.png")
        # self.n = self.n + 1
